...
export IMAGE_URL=${IMAGE_URL-quay.io/tsscui/java-springboot-edddgyre:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-org/java-springboot-edddgyre-gitops
